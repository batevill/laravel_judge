      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item mt-auto">
            <a href="{{ route('offer.index') }}" class="nav-link {{ (request()->is('admin/offer*')) ? 'active': '' }}">
          ...
          <li class="nav-item mt-auto">
            <a href="{{ route('position.index') }}" class="nav-link {{ (request()->is('admin/position*')) ? 'active': '' }}">
